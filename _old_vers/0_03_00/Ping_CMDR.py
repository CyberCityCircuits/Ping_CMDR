...
def ui():
    ...
    if ping_internet == 1:
        ...
        show_internet = "   Internet is \033[1;31;40mDOWN \033[1;37;40m- " + uptime_internet

    if ping_cmdr == 1:
        show_cmdr = "  Commander is UP   - " + uptime_cmdr
    else:
        show_cmdr = "  Commander is \033[1;31;40mDOWN \033[1;37;40m- " + uptime_cmdr

    if ping_ezr == 1:
        show_ezr = "     Router is UP   - " + uptime_ezr
    else:
        show_ezr = "     Router is \033[1;31;40mDOWN \033[1;37;40m- " + uptime_ezr

    if ping_pos1 == 1:
        show_pos1 = "        WS 1 is UP   - " + uptime_pos1
    else:
        show_pos1 = "        WS 1 is \033[1;31;40mDOWN \033[1;37;40m- " + uptime_pos1
        
    if ping_pos2 == 1:
        show_pos2 = "        WS 2 is UP   - " + uptime_pos2
    else:
        show_pos2 = "        WS 2 is \033[1;31;40mDOWN \033[1;37;40m- " + uptime_pos2
