...
def logo():
    ...
    system("echo off")
    print ("")
    print ("   .______    __  .__   __.   _______      ").center(width)
    print ("   |   _  \  |  | |  \ |  |  /  _____|     ").center(width)
    print ("   |  |_)  | |  | |   \|  | |  |  __       ").center(width)
    print ("   |   ___/  |  | |  . `  | |  | |_ |      ").center(width)
    print ("   |  |      |  | |  |\   | |  |__| |      ").center(width)
    print ("   | _|      |__| |__| \__|  \______|      ").center(width)
    print ("  ______ .___  ___.  _______  .______      ").center(width)
    print (" /      ||   \/   | |       \ |   _  \     ").center(width)
    print ("|  ,----'|  \  /  | |  .--.  ||  |_)  |    ").center(width)
    print ("|  |     |  |\/|  | |  |  |  ||      /     ").center(width)
    print ("|  `----.|  |  |  | |  '--'  ||  |\  \----.").center(width)
    print (" \______||__|  |__| |_______/ | _| `._____|").center(width)
    print ("")
    print ("Ping_CMDR V" + version).center(width)
...
def ui():
    ...
    if ping_internet == 1:
        show_internet = ("Internet is UP   - " + uptime_internet).center(width)
    else:
        show_internet = ("Internet is DOWN - " + uptime_internet).center(width)
    ...
    print ("PING_CMDR V" + version).center(width)
    print ("")
    print ("Current Time - " + currtime).center(width)
    print ("")
    if scan == 21:
        print ("<**              >").center(width)
    ...
    print show_internet
    print ""
    print (show_1 + " " + show_3).center(width)
    print (show_2 + " " + show_4).center(width)
    print ""
