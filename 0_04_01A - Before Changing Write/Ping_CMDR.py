...
output = ("Ping Log - " + currdate + " - " + start_time)
...
def main_menu():
    ...
    print ("  1 - ")
    print ("  2 - ")
    print ("  3 - Run Ping Tool (BP/Shell Sites Only)")
    print ("  4 - Run Ping Tool (Non-BP/Shell Sites)")
    print ("")
    option = input("  Enter Your Selection: [0/1/2/3/4] ")
    if option == (0):
        end()
    elif option == (3):
        ui = 1
...
def write_file(file_name):
    if var_internet != ping_internet: 
        if ping_internet == 1:
            f.write("Internet is UP   - " + uptime_internet + "\n")
        else:
            f.write("Internet is Down - " + uptime_internet + "\n")
    
    if var_1 != ping_1 and ping_1 == ("1"): 
        f.write(dev_1 + " is UP   - " + uptime_1 + "\n")        
        
    if var_1 != ping_1 and ping_1 == ("0"): 
        f.write(dev_1 + " is DOWN - " + uptime_1 + "\n")
   
    if var_2 != ping_2 and ping_2 == ("1"): 
        f.write(dev_2 + " is UP   - " + uptime_2 + "\n")        
        
    if var_2 != ping_2 and ping_2 == ("0"): 
        f.write(dev_2 + " is DOWN - " + uptime_2 + "\n")
        
    if var_3 != ping_3 and ping_3 == ("1"): 
        f.write(dev_3 + " is UP   - " + uptime_3 + "\n")        
        
    if var_3 != ping_3 and ping_3 == ("0"): 
        f.write(dev_3 + " is DOWN - " + uptime_3 + "\n")

    if var_4 != ping_4 and ping_4 == ("1"): 
        f.write(dev_4 + " is UP   - " + uptime_4 + "\n")        
        
    if var_4 != ping_4 and ping_4 == ("0"): 
        f.write(dev_4 + " is DOWN - " + uptime_4 + "\n")

    if var_5 != ping_5 and ping_5 == ("1"): 
        f.write(dev_5 + " is UP   - " + uptime_5 + "\n")        
        
    if var_5 != ping_5 and ping_5 == ("0"): 
        f.write(dev_5 + " is DOWN - " + uptime_5 + "\n")

    if var_6 != ping_6 and ping_6 == ("1"): 
        f.write(dev_6 + " is UP   - " + uptime_6 + "\n")        
        
    if var_6 != ping_6 and ping_6 == ("0"): 
        f.write(dev_6 + " is DOWN - " + uptime_6 + "\n") 
