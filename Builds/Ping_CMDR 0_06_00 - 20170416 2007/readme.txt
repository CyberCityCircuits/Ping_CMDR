...
***	Troubleshoot errors causing software to crash.

V0.04.03 12-05-2016
***	Changed how the screen refreshes to prevent recursive errors.

V0.06.00 04-16-2017
***	Rewrote entire script to allow the user to set a POS count.
	Current max for POS supported is 5.